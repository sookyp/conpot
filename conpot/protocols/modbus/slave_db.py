...
from modbus_tk.modbus import Databank, DuplicatedKeyError, MissingKeyError, ModbusInvalidRequestError
...
class SlaveBase(Databank):
    ...
    def handle_request(self, query, request, mode):
        ...
        try:
            ...
            response = query.build_response(r)
        except (ModbusInvalidRequestError, Exception) as e:
            # ModbusError should be handled in slave.py
            logger.info(e)
